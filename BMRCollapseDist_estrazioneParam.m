...
results = zeros(15,10);
for Rmin = 1:1           % scorre le finestre
    
    Rmax = Rmin + elements - 1;
    
    % sweep sugli esponenti
    bmin = 1; bstep = 1; bmax = 1; dmin = 0.5; dstep = 0.01; dmax = 1.5;
    ...
    ADvec = ADdata(:); ADind = [ones(251,1); 2*ones(251,1); 3*ones(251,1)]; %4*ones(211,1); 5*ones(21,1)];
